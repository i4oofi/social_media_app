...
class _CreateStoryScreenState extends State<CreateStoryScreen>
  ...
  void initState() {
    ...
    _canvasSlide = Tween<Offset>(begin: const Offset(0, 0.06), end: Offset.zero)
        .animate(
          CurvedAnimation(
            parent: _entranceCtrl,
            curve: const Interval(0.0, 0.6, curve: Curves.easeOut),
    ...
    ).animate(CurvedAnimation(parent: _shareCtrl, curve: Curves.easeInOut));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // ── Canvas — fills entire screen edge-to-edge ─────────────
          Positioned.fill(
                  ...
                  child: GestureDetector(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        // Text input — centered in full screen
                        Center(
                          child: Padding(
          ...
          // ── Top Toolbar — overlaid on canvas ──────────────────────
          Positioned(
            top: safePadding.top,
            left: 0,
            right: 0,
          ...
          // ── Bottom Controls — Color Picker + Share Bar ─────────────
          Positioned(
                  ...
                  AnimatedSwitcher(
                    ...
                    child: _focusNode.hasFocus
                        ? _ColorPicker(
                            ...
                            colors: _textColors.map((c) => [c, c]).toList(),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          _ToolbarIcon(icon: Icons.close_rounded, onTap: onClose),
          Row(
            children: [
              _ToolbarIcon(
...
class _ToolbarIconState extends State<_ToolbarIcon>
  ...
  Widget build(BuildContext context) {
    final Color iconColor =
        widget.color ?? (widget.active ? AppColors.primaryColor : Colors.white);
